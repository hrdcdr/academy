...
ADMINS = (('Смирных Андрей', 'smirnyh.andrey@gmail.com'),
...
DATABASES = {
    'default': {
        ...
        'NAME': rel('academy.db'),                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'vb#ml2x+5l=alpd)ix5&rnu%47hc@v035+xd=61@g#+0b-(1=n'
